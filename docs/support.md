...
The v2.1.0-beta.3 candidate keeps native diagnostics schema `1`, existing
...
range and result wording cover v2.0.5-v2.0.12 plus v2.1.0 beta/rc/stable. The service remains
