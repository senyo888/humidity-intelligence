...
(() => {
  ...
  class HIAdaptiveOutputCard extends HTMLElement {
    ...
    _build(){
      ...
      const title=node('span',undefined,'title');title.append(icon('fan'),node('span',this._t('outputs')));this._chevron=node('span',undefined,'chevron');this._chevron.setAttribute('aria-hidden','true');
